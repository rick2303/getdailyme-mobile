...
const IDENTICAL = [
  ...
  ['src/lib/activities/first-log.ts', 'lib/activities/first-log.ts'],
  ['src/lib/challenges/templates.ts', 'lib/challenges/templates.ts'],
  ['src/lib/api/activities.ts', 'lib/api/activities.ts'],
  ['src/lib/api/challenges.ts', 'lib/api/challenges.ts'],
  ['src/lib/api/clubs.ts', 'lib/api/clubs.ts'],
  ['src/lib/api/couple.ts', 'lib/api/couple.ts'],
  ['src/lib/api/couple-answers.ts', 'lib/api/couple-answers.ts'],
  ['src/lib/api/couple-prompts.ts', 'lib/api/couple-prompts.ts'],
  ...
  ['src/lib/api/stories.ts', 'lib/api/stories.ts'],
  ...
  ['src/lib/feed/inbox-copy.ts', 'lib/feed/inbox-copy.ts'],
  ...
  ['src/lib/couple/milestones.ts', 'lib/couple/milestones.ts'],
  ['src/lib/couple/prompts.ts', 'lib/couple/prompts.ts'],
...
const ADAPTED = [
  ...
  ['src/lib/hooks/use-first-log.ts', 'lib/hooks/use-first-log.ts'],
  ['src/lib/hooks/use-comments.ts', 'lib/hooks/use-comments.ts'],
  ['src/lib/hooks/use-challenges.ts', 'lib/hooks/use-challenges.ts'],
  ['src/lib/hooks/use-clubs.ts', 'lib/hooks/use-clubs.ts'],
  ['src/lib/hooks/use-couple.ts', 'lib/hooks/use-couple.ts'],
  ['src/lib/hooks/use-couple-answers.ts', 'lib/hooks/use-couple-answers.ts'],
  ['src/lib/hooks/use-couple-prompts.ts', 'lib/hooks/use-couple-prompts.ts'],
  ...
  ['src/lib/hooks/use-stories.ts', 'lib/hooks/use-stories.ts'],
  ['src/components/stories/reactions.ts', 'components/stories/reactions.ts'],
  ['src/components/invite/use-share-invite.ts', 'components/invite/use-share-invite.ts'],
  ['src/lib/auth/provider.tsx', 'lib/auth/provider.tsx'],
  ['src/lib/auth/last-method.ts', 'lib/auth/last-method.ts'],
